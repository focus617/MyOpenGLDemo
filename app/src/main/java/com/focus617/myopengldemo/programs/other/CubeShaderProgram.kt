...
import com.focus617.myopengldemo.programs.ShaderConstants.U_MATERIAL_AMBIENT
...
class CubeShaderProgram(context: Context) : ShaderProgram(
    ...
    fun setUniforms(
        ...
        setVector3fv(U_MATERIAL_AMBIENT,  Material.ambient, 1)
        setVector3fv(U_MATERIAL_DIFFUSE,  Material.diffuse,1)
